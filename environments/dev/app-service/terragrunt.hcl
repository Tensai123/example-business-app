...
dependency "security" {
  ...
  mock_outputs = {
    key_vault_id                      = "/subscriptions/mock/resourceGroups/poc-rg-dev/providers/Microsoft.KeyVault/vaults/poc-dev-kv-12345"
    key_vault_name                    = "poc-dev-kv-12345"
    key_vault_uri                     = "https://poc-dev-kv-12345.vault.azure.net/"
    sql_admin_password_secret_id      = "/subscriptions/mock/resourceGroups/poc-rg-dev/providers/Microsoft.KeyVault/vaults/poc-dev-kv-12345/secrets/sql-server-admin-password"
    key_vault_reference_sql_password  = "@Microsoft.KeyVault(VaultName=poc-dev-kv-12345;SecretName=sql-server-admin-password)"
  }
  mock_outputs_allowed_terraform_commands = ["plan", "validate", "destroy"]
}
...
dependency "database" {
  ...
  mock_outputs = {
    sql_server_id                    = "/subscriptions/mock/resourceGroups/poc-rg-dev/providers/Microsoft.Sql/servers/poc-dev-sqlsrv-12345"
    sql_server_name                  = "poc-dev-sqlsrv-12345"
    sql_server_fqdn                  = "poc-dev-sqlsrv-12345.database.windows.net"
    database_id                      = "/subscriptions/mock/resourceGroups/poc-rg-dev/providers/Microsoft.Sql/servers/poc-dev-sqlsrv-12345/databases/poc-dev-db"
    database_name                    = "poc-dev-db"
    connection_string_no_password    = "Server=tcp:poc-dev-sqlsrv-12345.database.windows.net,1433;Initial Catalog=poc-dev-db;Persist Security Info=False;User ID=sqladmin;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
