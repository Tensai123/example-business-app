...
sql_server_name    = "poc-dev-sqlsrv-12345"  # Must be globally unique
...
database_sku_name  = "Basic"  # Dev: Basic | Staging: S1 | Prod: S2+
zone_redundant     = false    # Dev: false | Prod: true

# Security settings (dev - more permissive)
minimum_tls_version                   = "1.2"
public_network_access_enabled         = true   # Dev: true | Prod: false
outbound_network_restriction_enabled  = false  # Dev: false | Prod: true

# Backup settings (dev - minimal)
backup_retention_days = 7      # Dev: 7 | Prod: 35
...
enable_threat_detection           = false  # Dev: false | Prod: true
